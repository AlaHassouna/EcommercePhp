<?php 
    ...
    // if(isset($_SESSION['ADMIN_LOGIN'])&& $_SESSION['ADMIN_LOGIN']!='' && $_SESSION['USER_LOGIN'] && $_SESSION['USER_LOGIN']!=''){
    // }else{
    //   header('location:login.php');
    //      die();
    // }
    $cat_res=mysqli_query( $con,"SELECT * FROM categories  order by id asc");
    $cat_arr=array();
                    ...
                    <div class="row">
                        <div class="menumenu__container clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-5"> 
                                <div class="logo">
                                     <a href="index.php"><img src="images/logo3.png" alt="logo images" width="60"></a>
                                </div>
                            </div>

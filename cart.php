                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><<img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$image ?>" alt="full-image"></a></td>
                                            <td class="product-name"><a href="#"><?php echo $pname; ?></a>
                                                <ul  class="pro__prize">
                                                    <li class="old__prize" style="text-decoration-line: line-through;"><?php echo $mrp; ?></li>

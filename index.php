                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>T-shirt Lacoste Noir</h1>
                                        <div class="cr__btn">
                                            <a href="http://localhost/store/storeTheme/product.php?id=8">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    <div class="slider__inner">
                                        ...
                                        <h1>Abaya Bleu</h1>
                                        <div class="cr__btn">
                                            <a href="http://localhost/store/storeTheme/product.php?id=12">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

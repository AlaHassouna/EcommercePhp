                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <ul  class="pro__prize">
                                    <li class="old__prize" style="text-decoration-line: line-through;"><?php echo $get_product['0']['mrp'] ?></li>
                                ...
                                onclick="manage_cart('<?php echo $get_product['0']['id'] ?>','add')" class="fr__btn">Add to cart</a>
